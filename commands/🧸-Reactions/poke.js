...
module.exports = {
    ...
    category: '🧸-Reactions',
    aliases: ['choc'],
    usage: '%poke [tag/id người dùng]',
    descriptions: 'Dành một cái chọc cho người khác',
    run: async (client, message, args) => {
        ...
        .then(data=> {
            ...
            .setColor('GREEN')
            .setAuthor('Reaction: Poke',client.user.displayAvatarURL({ size: 1024, dynamic: true }))
            .setDescription(`${message.member.displayName} đã dành một cái chọt cho ${member.displayName}`)
            .setImage(data.url)
            .setTimestamp()
