...
module.exports = {
    ...
    category: 'Reactions',
    aliases: ['hon', 'hun'],
    usage: '%kiss [tag/id người dùng]',
    descriptions: 'Dành một cái hôn cho người khác',
    run: async (client, message, args) => {
        ...
        .then(data=> {
            ...
            .setColor('GREEN')
            .setAuthor('Reaction: Kiss',client.user.displayAvatarURL({ size: 1024, dynamic: true }))
            .setDescription(`${message.member.displayName} đã dành một cái hôn cho ${member.displayName}`)
            .setImage(data.url)
            .setTimestamp()
